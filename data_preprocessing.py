...
test_images_raw = idx2numpy.convert_from_file('t10k-images.idx3-ubyte')
...
test_images_0, test_labels_0 = filter_data((test_images_raw, test_labels_raw), condition=0)
test_images_1, test_labels_1 = filter_data((test_images_raw, test_labels_raw), condition=1)
...
test_images  = np.concatenate((test_images_0, test_images_1), axis=0)
